export default {
  ...
  expectedRecipe: {
    ...
    description: "You've made oatmeal-raisin cookies before, so why try these? Because they're moist, chewy and loi aded with raisins - and they're better than any you've tried before! From Cuisine Magazinei don't remrmber  been to long",
    ingredients: [
    ...
    sectionedInstructions: [
      { sectionTitle: '', text: 'Preheat oven to 350°.', image: '' },
      {
        sectionTitle: '',
    ...
    servings: '36 cookies, 36 serving(s)',
