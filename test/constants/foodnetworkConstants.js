module.exports = {
  ...
  expectedRecipe: {
    ...
    tags: ["Comfort Food","Cast Iron Skillet","Skillet Recipes","French Recipes","Pork Chop","Pork","Potato","Main Dish","Gluten Free"],
    time: {
      prep: "",
      cook: "",
      active: "40 min",
  ...
  anotherExpectedRecipe: {
    ...
    tags: ["Vegetarian","Dutch Oven","American","Bread","Cornmeal","Grain Recipes","Side Dish","Low-Cholesterol","Low-Fat","Vegan"],
    time: {
      prep: "10 min",
      cook: "45 min",
      active: "",
