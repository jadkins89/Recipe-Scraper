module.exports = {
  ...
  expectedRecipe: {
    ...
    instructions: [
      ...
      "tip: toasting the spices boosts their flavour by releasing aromatic oils. Keep them moving in the pan to prevent burning."
    ],
    tags: [],
    time: {
      prep: "15 Mins",
    ...
    servings: "4",
    image:
      "https://cdn1.woolworths.media/content/recipes/1804-bean-and-tomato-nachos.jpg"
  }
};
